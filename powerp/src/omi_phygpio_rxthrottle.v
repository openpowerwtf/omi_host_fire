...
// this version throttles rxvalid for 66:1, instead of relying on 66:1 dl clk
...
module omi_phygpio_rxthrottle #(
        parameter GPIO_RX_TX = 8, parameter GPIO_HDR = 0,
 ...
 */
   ...
   // to dl
   assign ln0_rx_valid = ratio_counter_q == 0; //ratio_max;
   assign ln1_rx_valid = ratio_counter_q == 0; //ratio_max;
   assign ln2_rx_valid = ratio_counter_q == 0; //ratio_max;
   assign ln3_rx_valid = ratio_counter_q == 0; //ratio_max;
   assign ln4_rx_valid = ratio_counter_q == 0; //ratio_max;
   assign ln5_rx_valid = ratio_counter_q == 0; //ratio_max;
   assign ln6_rx_valid = ratio_counter_q == 0; //ratio_max;
   assign ln7_rx_valid = ratio_counter_q == 0; //ratio_max;
